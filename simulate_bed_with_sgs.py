...
glc_outline = gu.Vector(r"C:/Users/kneibm/Documents/Projects/Collaborator/2024_AirETH/planp_mask.shp")

# Load thickness obs
zbed_ds = gpd.read_file(r"C:/Users/kneibm/Documents/Projects/Collaborator/2024_AirETH/planp_GPR_data.shp")
zbed = zbed_ds.Hgpr
zbed_x = zbed_ds.geometry.x
zbed_y = zbed_ds.geometry.y

# load data from DEM to be coherent with methodology
mnt = gu.Raster(r"C:/Users/kneibm/Documents/Projects/Collaborator/2024_AirETH/planp_dem.tif")
zsurf = mnt.value_at_coords(zbed_x, zbed_y)
...
H_model = gu.Raster(r"C:/Users/kneibm/Documents/Projects/Collaborator/2024_AirETH/ICE_GlaTe_10m.tif")
H_model = H_model.reproject(mnt, resampling= "bilinear")
H_model = mnt-H_model
left, bottom, right, top = list(glc_outline.bounds)
H_model.crop([left - 200, bottom - 200, right + 200, top + 200])
# H_model.crop(glc_outline)
...
glc_outline.show(fc="none", ec="k", ax=axes[0, 0])

# Residuals map
cmap = "coolwarm"
vmax = 150
glc_outline.show(fc="none", ec="k", ax=axes[0, 1])
...
mask1 = glc_outline.create_mask(H_model)
mask2 = glc_outline.create_mask(H_model, buffer=H_model.res[0])
